...
<div class="container">
  <div class="box">
    <form method="post" enctype="multipart/form-data">
      ...
      <textarea name="h-description" id="h-description" rows="8" placeholder="Description"></textarea>
...
if(isset($_POST['add-btn'])){
    ...
    // Get form data
    $hname = $_POST['h-name'];
    $hlocation = $_POST['h-location'];
    $hprice = $_POST['h-price'];
    $hdescription = $_POST['h-description'];
    $image = addslashes(file_get_contents($_FILES["file"]["tmp_name"]));

    // Insert record
    $query = "INSERT INTO `hotels_list` (h_name, h_location, h_price, h_description, h_image) VALUES ('$hname', '$hlocation', '$hprice', '$hdescription', '$image')";
